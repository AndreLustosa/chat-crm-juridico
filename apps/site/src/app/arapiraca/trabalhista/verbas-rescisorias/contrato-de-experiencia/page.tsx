...
import { ContratoExperienciaTemplate } from "@/components/lp/templates/ContratoExperienciaTemplate";
...
export const metadata: Metadata = {
  ...
  keywords:
    "contrato de experiência Arapiraca, rescisão contrato de experiência, demissão antes do fim da experiência, art 479 CLT, verbas rescisórias experiência",
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Contrato de experiência e verbas rescisórias em Arapiraca",
      },
    ],
  },
  twitter: {
...
export default function ContratoExperienciaPage() {
  const legalServiceJsonLd = {
    ...
    name: "André Lustosa Advogados - Contrato de Experiência em Arapiraca",
    description: pageDescription,
    image: heroImage,
    url: pageUrl,
  ...
  return (
    <>
      <Script
        id="json-ld-contrato-experiencia-service"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(legalServiceJsonLd) }}
      />
      <Script
        id="json-ld-contrato-experiencia-faq"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqJsonLd) }}
      />
      <Script
        id="json-ld-contrato-experiencia-breadcrumb"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd) }}
      />
      <LPTracker />
      <ContratoExperienciaTemplate />
    </>
  );
}
