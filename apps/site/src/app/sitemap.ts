...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: `${baseUrl}/arapiraca/trabalhista/insalubridade-periculosidade`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/arapiraca/trabalhista/assedio-moral-sexual`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    ...
    {
      url: `${baseUrl}/arapiraca/trabalhista/verbas-rescisorias/seguro-desemprego`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.88,
    },
    {
      url: `${baseUrl}/arapiraca/trabalhista/verbas-rescisorias/multa-art-477`,
      lastModified: new Date(),
      changeFrequency: 'monthly',
      priority: 0.88,
    },
