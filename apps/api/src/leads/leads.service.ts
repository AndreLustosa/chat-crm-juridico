...
export class LeadsService {
  ...
  async update(
    ...
    data: {
      ...
      full_name?: string; nationality?: string; marital_status?: string; profession?: string; birth_date?: string; mother_name?: string;
    ...
    const QUALI_TEXT = ['full_name', 'nationality', 'marital_status', 'profession', 'birth_date', 'mother_name', 'rg', 'rg_issuer', 'address_cep', 'address_street', 'address_number', 'address_complement', 'address_neighborhood', 'address_city', 'address_state'] as const;
