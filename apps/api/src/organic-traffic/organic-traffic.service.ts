...
export class OrganicTrafficService {
  ...
  private getDefaultLandingPages(base: string) {
    return [
      ...
      {
        url: `${base}/arapiraca/trabalhista/verbas-rescisorias/dispensa-sem-justa-causa`,
        path: '/arapiraca/trabalhista/verbas-rescisorias/dispensa-sem-justa-causa',
        title: 'Arapiraca - Dispensa Sem Justa Causa',
        city: 'Arapiraca',
        state: 'AL',
        practice_area: 'Trabalhista',
        target_keywords: [
          'dispensa sem justa causa arapiraca',
          'demissao sem justa causa arapiraca',
          'verbas rescisorias sem justa causa arapiraca',
          'multa 40 fgts arapiraca',
        ],
      },
      {
        url: `${base}/arapiraca/trabalhista/verbas-rescisorias/pedido-de-demissao`,
        path: '/arapiraca/trabalhista/verbas-rescisorias/pedido-de-demissao',
        title: 'Arapiraca - Pedido de Demissao',
        city: 'Arapiraca',
        state: 'AL',
        practice_area: 'Trabalhista',
        target_keywords: [
          'pedido de demissao arapiraca',
          'verbas rescisorias pedido de demissao arapiraca',
          'direitos pedido de demissao arapiraca',
      ...
      {
        url: `${base}/arapiraca/trabalhista/verbas-rescisorias/rescisao-indireta`,
        path: '/arapiraca/trabalhista/verbas-rescisorias/rescisao-indireta',
        title: 'Arapiraca - Rescisao Indireta',
        city: 'Arapiraca',
        state: 'AL',
        practice_area: 'Trabalhista',
        target_keywords: [
          'rescisao indireta arapiraca',
          'justa causa do empregador arapiraca',
          'fgts nao depositado arapiraca',
          'salario atrasado rescisao indireta arapiraca',
        ],
      },
      {
        url: `${base}/arapiraca/trabalhista/verbas-rescisorias/rescisao-por-acordo`,
        path: '/arapiraca/trabalhista/verbas-rescisorias/rescisao-por-acordo',
        title: 'Arapiraca - Rescisao por Acordo',
        city: 'Arapiraca',
        state: 'AL',
        practice_area: 'Trabalhista',
        target_keywords: [
          'rescisao por acordo arapiraca',
          'acordo trabalhista arapiraca',
          'multa 20 fgts arapiraca',
          'saque 80 fgts acordo trabalhista',
        ],
      },
      {
