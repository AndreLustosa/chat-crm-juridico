...
import {
  ...
  whatsappMessage,
  whatsappNumber,
} from "@/app/arapiraca/trabalhista/verbas-rescisorias/rescisao-indireta/content";
...
export function RescisaoIndiretaTemplate() {
  return (
      ...
      <main>
        <section className="relative min-h-[94svh] overflow-hidden pt-24">
          <div className="absolute inset-0">
            <img
              src="/landing/rescisao-indireta-hero.webp"
              srcSet="/landing/rescisao-indireta-hero-mobile.webp 800w, /landing/rescisao-indireta-hero.webp 1600w"
              sizes="100vw"
              alt="Trabalhador saindo da empresa com carteira de trabalho e documentos"
          ...
          <div className="absolute inset-0 bg-linear-to-r from-black via-black/86 to-black/35" />
          ...
          <div className="relative z-10 mx-auto flex min-h-[calc(94svh-6rem)] w-full max-w-7xl items-center px-5 py-16 sm:px-8">
            <div className="max-w-3xl">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#b8944d]/40 bg-black/45 px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-[#d8bd79]">
                ...
                Rescisão indireta em Arapiraca-AL
              </div>
              <h1 className="max-w-4xl text-[clamp(2.35rem,6vw,6.1rem)] font-black leading-[0.95] tracking-normal">
                A empresa descumpriu o contrato?
              </h1>
              <p className="mt-7 max-w-2xl text-lg leading-relaxed text-slate-200 sm:text-xl">
                Quando o empregador comete falta grave, você pode buscar a
                rescisão indireta para sair sem perder verbas típicas da dispensa
                sem justa causa.
              </p>
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <PrimaryButton>Analisar rescisão indireta</PrimaryButton>
                <a
                  href="#motivos"
        ...
        <section className="bg-[#101010] py-20 sm:py-24">
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
            <div className="max-w-3xl">
              <SectionLabel>Entenda a saída</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Rescisão indireta é a justa causa da empresa
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                Ela existe para proteger o trabalhador quando a permanência no
                emprego fica inviável por culpa da empresa. O cuidado principal é
                provar a falta grave antes de tomar uma decisão precipitada.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-3">
              {conceptCards.map((item) => (
                ...
                >
                  <DoorOpen className="mb-5 text-[#d8bd79]" size={28} />
        ...
        <section id="motivos" className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
            <div className="max-w-3xl">
              <SectionLabel>Faltas da empresa</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Quando a rescisão indireta pode ser analisada
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                O pedido ganha força quando a irregularidade é grave, comprovável
                e torna injusto exigir que o trabalhador continue no emprego.
              </p>
            </div>

            <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
              {employerFaults.map((item) => (
                <article
                  key={item.title}
        ...
        <section className="bg-[#101010] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              <SectionLabel>Direitos preservados</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                O que pode ser cobrado se a falta da empresa for reconhecida
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                O grande ponto da rescisão indireta é evitar que o trabalhador
                peça demissão e abra mão de direitos que seriam devidos em uma
                dispensa sem justa causa.
              </p>
              <div className="mt-8 rounded-lg border border-[#22c55e]/25 bg-[#0d1a12] p-6">
                <div className="flex gap-3">
                  <ShieldCheck className="mt-1 shrink-0 text-[#22c55e]" />
                  <p className="leading-relaxed text-slate-200">
                    Quando reconhecida, a rescisão indireta pode gerar aviso,
                    férias, 13º, FGTS, multa de 40% e guias, conforme o caso.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              <SectionLabel>Cuidado antes de sair</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Erros que podem enfraquecer o caso
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                A estratégia importa. Sair no impulso, pedir demissão ou abandonar
                o emprego sem organizar provas pode dificultar a cobrança.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
        ...
        <section className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                O que separar para provar a falta da empresa
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                Prova documental costuma ser decisiva. Comece reunindo tudo que
                mostre atraso, FGTS faltando, assédio, jornada ou risco no trabalho.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              {documents.map((item) => (
        ...
        <section className="bg-[#080808] py-20 sm:py-28">
          <div className="mx-auto w-full max-w-5xl px-5 text-center sm:px-8">
            <ClipboardCheck className="mx-auto mb-6 text-[#d8bd79]" size={44} />
            <h2 className="text-[clamp(2.2rem,5vw,4.6rem)] font-black leading-tight">
              Antes de pedir demissão, confira se o erro é da empresa.
            </h2>
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">
              Envie seus documentos para uma análise trabalhista. A prioridade é
              entender se existe fundamento para rescisão indireta e quais verbas
              podem ser preservadas.
            </p>
            <div className="mt-9">
              <PrimaryButton>Quero analisar meu caso</PrimaryButton>
            </div>
          </div>
        </section>
      </main>
