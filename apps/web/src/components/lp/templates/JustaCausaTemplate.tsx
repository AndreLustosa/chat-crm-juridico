...
import {
  ...
  whatsappNumber,
  whatIsJustCause,
} from "@/app/arapiraca/trabalhista/verbas-rescisorias/justa-causa/content";
...
export function JustaCausaTemplate() {
  return (
      ...
      <main>
          ...
          <div className="relative z-10 mx-auto flex min-h-[calc(94svh-6rem)] w-full max-w-7xl items-center px-5 py-16 sm:px-8">
            <div className="max-w-3xl">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#b8944d]/40 bg-black/45 px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-[#d8bd79]">
                ...
                Reversão de justa causa em Arapiraca-AL
              </div>
              <h1 className="max-w-4xl text-[clamp(2.35rem,6vw,6.1rem)] font-black leading-[0.95] tracking-normal">
                Justa causa indevida pode ser revertida.
              </h1>
              <p className="mt-7 max-w-2xl text-lg leading-relaxed text-slate-200 sm:text-xl">
                Se a empresa aplicou justa causa sem prova, com exagero ou por
                perseguição, é possível analisar a reversão e a recuperação das
                verbas perdidas.
              </p>
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <PrimaryButton>Analisar minha justa causa</PrimaryButton>
                <a
                  href="#reversao"
        ...
        <section className="bg-[#101010] py-20 sm:py-24">
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
            <div className="max-w-3xl">
              <SectionLabel>Entenda a penalidade</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Justa causa não é uma demissão comum
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                É a punição mais pesada dentro do contrato de trabalho. Por isso,
                precisa de base concreta e deve respeitar proporcionalidade,
                imediatidade e coerência com os fatos.
              </p>
            </div>

            <div className="mt-12 grid gap-5 md:grid-cols-3">
              {whatIsJustCause.map((item) => (
                <article
                  key={item.title}
                  className="rounded-lg border border-[#b8944d]/20 bg-[#141414] p-6"
                >
                  <Gavel className="mb-5 text-[#d8bd79]" size={28} />
        ...
        <section id="reversao" className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              <SectionLabel>Quando questionar</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Sinais de que a justa causa pode ser indevida
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                O foco da análise é descobrir se a empresa tinha motivo grave,
                prova suficiente e se a punição máxima foi realmente proporcional.
              </p>
              <div className="mt-8 rounded-lg border border-[#22c55e]/25 bg-[#0d1a12] p-6">
                <div className="flex gap-3">
                  <RotateCcw className="mt-1 shrink-0 text-[#22c55e]" />
                  <p className="leading-relaxed text-slate-200">
                    A reversão pode transformar uma justa causa injusta em
                    dispensa sem justa causa, abrindo caminho para cobrar as
        ...
        <section className="bg-[#101010] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-2">
            <div>
              <SectionLabel>Na justa causa</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,3.7rem)] font-black leading-tight">
                O que costuma ser pago
              </h2>
              <div className="mt-8 grid gap-5">
                {paidInJustCause.map((item) => (
                  <article
                    key={item.title}
                    className="rounded-lg border border-[#b8944d]/20 bg-[#141414] p-6"
                  >
            ...
            <div>
              <SectionLabel>Direitos bloqueados</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,3.7rem)] font-black leading-tight">
                O que pode ser recuperado se houver reversão
              </h2>
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                {lostOrBlocked.map((item) => (
                  <div
                    key={item}
                    className="flex items-start gap-3 rounded-lg border border-white/10 bg-[#181818] p-4"
                  >
                    <XCircle size={19} className="mt-0.5 shrink-0 text-[#f97316]" />
                    <span className="font-semibold leading-relaxed text-slate-200">
                      {item}
                    </span>
                  </div>
        ...
        <section className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
            <div className="max-w-3xl">
              <SectionLabel>Efeitos da reversão</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                O que a reversão pode mudar no seu caso
              </h2>
            </div>
            <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
              {reversalEffects.map((item) => (
                <article
                  key={item.title}
                  className="rounded-lg border border-[#b8944d]/20 bg-[#141414] p-6"
                >
                  <RotateCcw className="mb-5 text-[#22c55e]" size={28} />
        ...
        <section className="bg-[#101010] py-20 sm:py-24">
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
            <div className="max-w-3xl">
              ...
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Análise para tentar reverter a justa causa
              </h2>
            </div>
            <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        <section className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                O que separar para analisar
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                Quanto mais rápido você organizar documentos e provas, melhor fica
                a análise sobre a justa causa e os riscos da ação.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              {documents.map((item) => (
        ...
        <section className="bg-[#080808] py-20 sm:py-28">
          <div className="mx-auto w-full max-w-5xl px-5 text-center sm:px-8">
            ...
            <h2 className="text-[clamp(2.2rem,5vw,4.6rem)] font-black leading-tight">
              Recebeu justa causa e acha que foi injusto?
            </h2>
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">
              Envie o comunicado, o TRCT e as provas disponíveis para uma análise
              trabalhista. A prioridade é entender se existe caminho real para
              reversão e recuperação das verbas.
            </p>
            <div className="mt-9">
              <PrimaryButton>Quero analisar a reversão</PrimaryButton>
            </div>
          </div>
        </section>
      </main>
