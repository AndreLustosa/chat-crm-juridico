...
import {
  ...
  whatsappMessage,
  whatsappNumber,
} from "@/app/arapiraca/trabalhista/verbas-rescisorias/contrato-de-experiencia/content";
...
export function ContratoExperienciaTemplate() {
  return (
    <div className="min-h-screen bg-[#080808] text-white">
      ...
      <main>
          ...
          <div className="relative z-10 mx-auto flex min-h-[calc(94svh-6rem)] w-full max-w-7xl items-center px-5 py-16 sm:px-8">
            <div className="max-w-3xl">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#b8944d]/40 bg-black/45 px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-[#d8bd79]">
                ...
                Contrato de experiência em Arapiraca-AL
              </div>
              <h1 className="max-w-4xl text-[clamp(2.35rem,6vw,6.1rem)] font-black leading-[0.95] tracking-normal">
                Seu contrato de experiência terminou antes do prazo?
              </h1>
              <p className="mt-7 max-w-2xl text-lg leading-relaxed text-slate-200 sm:text-xl">
                Entenda o que muda quando a experiência termina no prazo, quando
                a empresa encerra antes ou quando o trabalhador sai antes do fim.
              </p>
          ...
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
            <div className="max-w-3xl">
              ...
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Contrato de experiência tem regra própria
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                O erro mais comum é tratar toda saída na experiência como se fosse
                igual. Término normal, dispensa antecipada e saída antecipada pelo
                trabalhador geram cálculos diferentes.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-3">
              {conceptCards.map((item) => (
                ...
                >
                  <CalendarDays className="mb-5 text-[#d8bd79]" size={28} />
        ...
        <section id="modalidades" className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
            <div className="max-w-3xl">
              <SectionLabel>Situações de saída</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Cada forma de encerramento muda as verbas
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                Antes de aceitar o cálculo, é importante identificar exatamente
                como o contrato terminou e se o prazo foi respeitado.
              </p>
            </div>
        ...
        <section className="bg-[#101010] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              <SectionLabel>Verbas a conferir</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                O que pode entrar no cálculo da experiência
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                O valor correto depende de datas, motivo do encerramento, cláusulas
                do contrato, FGTS e eventuais descontos lançados pela empresa.
              </p>
              <div className="mt-8 rounded-lg border border-[#22c55e]/25 bg-[#0d1a12] p-6">
                <div className="flex gap-3">
                  ...
                  <p className="leading-relaxed text-slate-200">
                    Quando a empresa encerra antes do prazo, a indenização do art.
                    479 da CLT pode fazer diferença no total da rescisão.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              <SectionLabel>Pontos de alerta</SectionLabel>
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Quando o contrato de experiência merece revisão
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                Datas erradas, prorrogação irregular, FGTS faltando e desconto
                indevido podem transformar uma rescisão simples em cobrança de
                diferenças.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
        ...
        <section className="bg-[#101010] py-20 sm:py-24">
          <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
            <div className="max-w-3xl">
              ...
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Análise do contrato e da rescisão
              </h2>
            </div>
        ...
        <section className="bg-[#080808] py-20 sm:py-24">
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                O que separar para conferir a experiência
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-slate-300">
                O contrato e as datas são o ponto de partida. Com eles, é possível
                comparar o que foi assinado com o que foi pago na saída.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              {documents.map((item) => (
        ...
        <section className="bg-[#101010] py-20 sm:py-24">
          <div className="mx-auto w-full max-w-5xl px-5 sm:px-8">
            <div className="text-center">
              ...
              <h2 className="text-[clamp(2rem,4vw,4rem)] font-black leading-tight">
                Perguntas sobre contrato de experiência
              </h2>
            </div>
        ...
        <section className="bg-[#080808] py-20 sm:py-28">
          <div className="mx-auto w-full max-w-5xl px-5 text-center sm:px-8">
            ...
            <h2 className="text-[clamp(2.2rem,5vw,4.6rem)] font-black leading-tight">
              Recebeu a rescisão da experiência e não sabe se está correta?
            </h2>
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">
              Envie o contrato, TRCT e comprovante de pagamento para uma análise.
              A conferência mostra se o prazo, a modalidade e o cálculo foram
              aplicados corretamente.
            </p>
            <div className="mt-9">
              <PrimaryButton>Analisar contrato de experiência</PrimaryButton>
            </div>
          </div>
        </section>
      </main>
