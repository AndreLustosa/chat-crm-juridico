  ...
  server.registerTool(
    'traffic_create_search_campaign',
    {
      ...
      inputSchema: {
        ...
        contains_eu_political_advertising: z.boolean().optional().describe('Declaracao de propaganda politica na UE — obrigatorio no Google Ads (API v23+). Default false (advocacia NAO e propaganda politica). Marque true so se a campanha realmente veicular propaganda politica na UE.'),
        ...
        const result = await crmTrafficService.post(
          '/trafego/campaigns',
          {
            ...
            contains_eu_political_advertising:
              input.contains_eu_political_advertising,
            validate_only: input.validate_only,
          },
          { toolCallId },
        );
  ...
  server.registerTool(
    'traffic_create_pmax_campaign',
    {
      ...
      inputSchema: {
        ...
        reason: z.string().optional(),
        contains_eu_political_advertising: z.boolean().optional().describe('Declaracao de propaganda politica na UE — obrigatorio no Google Ads (API v23+). Default false (advocacia NAO e propaganda politica).'),
        validate_only: z.boolean().optional(),
      },
      annotations: { readOnlyHint: false, destructiveHint: false },
    },
